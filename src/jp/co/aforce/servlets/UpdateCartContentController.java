...
import jp.co.aforce.models.UpdateCartItemModel;

@WebServlet(urlPatterns = {"/jp/co/aforce/servlets/UpdateCartContentController"})
public class UpdateCartContentController extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int update = model.updateCartItem(item_count, total_price, cart_item_num);
